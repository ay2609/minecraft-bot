...
- [ ] **FOUND-01**: Developer can initialize the project with a single command (`npm install`) and run the bot with `npm start`; TypeScript compiles via tsx, CJS modules, ESLint enforces `no-floating-promises`
